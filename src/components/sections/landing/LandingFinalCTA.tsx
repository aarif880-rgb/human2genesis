    ...
    <section className="section-y section-x relative overflow-hidden">
      ...
      <div className="relative z-10 container-max text-center max-w-[700px]">
        ...
        <p className="text-base text-text-secondary font-light max-w-md mx-auto mb-10">
          Four frameworks. Thirty prompts. One operating system. ৳{PRODUCT.price} — {PRODUCT.urgency}.
        </p>
        ...
        <a
          ...
          className="inline-flex items-center gap-3 text-base font-semibold px-8 py-4 rounded-[10px] text-white hover:-translate-y-px transition-all duration-200 mb-6"
