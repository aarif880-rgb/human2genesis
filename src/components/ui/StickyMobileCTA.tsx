  ...
  return (
    ...
    >
      <a
        ...
        onClick={handleClick}
        className="w-full flex items-center justify-center gap-2 py-4 rounded-[12px] font-display font-bold text-base text-white transition-all active:scale-[0.98]"
        style={{
