...
export const metadata: Metadata = {
  ...
  description:
    "Stop using AI like a beginner. The AI Creator's Blueprint is a structured AI operating system for Bangladeshi freelancers, creators, and professionals. Launch Special: ৳199.",
